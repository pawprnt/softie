...
class TrayIcon(QSystemTrayIcon):
    def __init__(self, engine, open_main, open_settings, open_focus=None, open_breathe=None, parent: QObject | None = None):
        ...
        menu.addAction("Focus", open_focus or open_main)
        menu.addAction("Breathe", open_breathe or open_main)
